...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>BikeShare - Lease & Test Premium Bikes</title>
        <meta name="description" content="Discover your perfect bike through flexible leasing. Test different brands and styles before you buy." />
        ...
        <div className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600">Simple steps to find your perfect bike</p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-12">
              <div className="text-center">
                ...
                <p className="text-gray-600">Explore bikes from different brands and categories. Filter by type, price, and location.</p>
              </div>
              <div className="text-center">
                <div className="bg-green-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6">
                  <span className="text-2xl">📅</span>
                </div>
                <h3 className="text-xl font-semibold mb-4">Choose Duration</h3>
                <p className="text-gray-600">Select from 1, 3, 6, or 12-month lease options. Flexible terms to fit your needs.</p>
              </div>
              <div className="text-center">
                <div className="bg-purple-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6">
                  <span className="text-2xl">🚴‍♂️</span>
                </div>
                <h3 className="text-xl font-semibold mb-4">Ride & Enjoy</h3>
                <p className="text-gray-600">Pick up your bike and start exploring. Extend your lease or try a different bike anytime.</p>
              </div>
            </div>
          </div>
        </div>
